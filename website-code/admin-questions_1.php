...
$sql = "SELECT c.Category, q.SOQnum, q.question, s.SetName FROM category c LEFT JOIN questions q on c.id = q.fk_Category LEFT JOIN QuestionSet s on q.fk_QuestionSetID = s.id WHERE q.fk_Category = 1 ORDER BY q.fk_QuestionSetID asc, SOQnum asc";
